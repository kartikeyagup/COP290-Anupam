...
public:
    ...
    void setupUi(QDialog *Finalinterface)
    {
        ...
        Finalinterface->resize(1000, 1000);
        ...
        label_2->setGeometry(QRect(660, 40, 91, 17));
        ...
        DeleteAccount->setGeometry(QRect(10, 510, 121, 27));
        ...
        syncselected = new QPushButton(Finalinterface);
        syncselected->setObjectName(QStringLiteral("syncselected"));
        syncselected->setGeometry(QRect(150, 510, 99, 27));
        listView = new QListView(Finalinterface);
        listView->setObjectName(QStringLiteral("listView"));
        listView->setGeometry(QRect(600, 80, 256, 301));
        treeView = new QTreeView(Finalinterface);
        treeView->setObjectName(QStringLiteral("treeView"));
        treeView->setGeometry(QRect(290, 80, 256, 301));
    ...
    void retranslateUi(QDialog *Finalinterface)
    {
        ...
        pushButton->setText(QApplication::translate("Finalinterface", "Make Dir", 0));
        pushButton_2->setText(QApplication::translate("Finalinterface", "Remove Dir", 0));
        syncselected->setText(QApplication::translate("Finalinterface", "Sync file", 0));
    } // retranslateUi
