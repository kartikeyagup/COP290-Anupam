...
#include "../Trialfilesystem/filewindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FileWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 32, 5)
    ...
    "FileWindow\0on_treeView_clicked\0\0index\0"
};
...
const QMetaObject FileWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FileWindow.data,
      qt_meta_data_FileWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FileWindow.stringdata))
